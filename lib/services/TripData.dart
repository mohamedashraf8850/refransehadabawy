...
class TripData {
  ...
  TripData.fromSnapshot(DocumentSnapshot documentSnapshot) {
    ...
    this.Drive_Name = documentSnapshot.data()['Driver']!=null?documentSnapshot.data()['Driver']["dName"]:null;
    this.Drive_phone =  documentSnapshot.data()['Driver']!=null?documentSnapshot.data()['Driver']["dPhone"]:null;
    this.Drive_Location =  documentSnapshot.data()['Driver']!=null?documentSnapshot.data()['Driver']["dlocation"]:null;
    this.Drive_RT_Location = documentSnapshot.data()["TrackDriver"]??null;
    this.Drive_Id =  documentSnapshot.data()['Driver']!=null?documentSnapshot.data()['Driver']["dId"]:null;
  }
}
